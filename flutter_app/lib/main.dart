...
import 'presentation/screens/admin/admin_staff_screen.dart';
import 'presentation/screens/admin/admin_menu_screen.dart';
import 'presentation/screens/admin/admin_inventory_screen.dart';
import 'presentation/screens/admin/admin_financial_screen.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        '/admin/staff': (_) => const AdminStaffScreen(),
        '/admin/menu': (_) => const AdminMenuScreen(),
        '/admin/inventory': (_) => const AdminInventoryScreen(),
...
class _MainShellState extends ConsumerState<MainShell> {
  ...
  List<_TabDef> get _tabs => switch (widget.role) {
        UserRole.admin => [
            _TabDef('Overview',   Icons.dashboard_outlined,    Icons.dashboard,    const AdminDashboardScreen()),
